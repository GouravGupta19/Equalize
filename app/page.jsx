...
export default function LandingPage() {
  return (
    <div className="flex flex-col">
      {/* ───── Hero ───── */}
      <section className="px-5 pt-16 pb-12 md:pt-20">
        ...
        <div className="mx-auto mt-10 w-full max-w-5xl px-0 sm:px-4 md:mt-14">
          <div className="gradient rounded-2xl p-1 shadow-2xl shadow-teal-900/20">
            <div className="relative aspect-video overflow-hidden rounded-xl bg-background">
              <Image
                ...
                alt="Equalize dashboard preview"
      ...
      <footer className="border-t bg-gray-50 py-12 text-center text-sm text-muted-foreground">
        © {new Date().getFullYear()}Equalize. All rights reserved.
      </footer>
    </div>
  );
}
